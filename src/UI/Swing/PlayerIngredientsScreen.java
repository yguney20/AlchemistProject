...
public class PlayerIngredientsScreen extends JFrame{
	...
	public void addIngredients() {
		try {
	        ...
	        Map<IngredientCard, JLabel> ingredientLabelMap = new HashMap<>();
	        ...
	        for (IngredientCard card : ingredientCards) {
	        	...
	        	ingredientLabel.setBorder(BorderFactory.createEmptyBorder());
	        	setImage(card.getImagePath(), ingredientLabel);
	        	contentPane.add(ingredientLabel);
	        
	        	ingredientLabelMap.put(card, ingredientLabel);
            
	        	// Create label for the artifact
	        	JLabel ingredientNameLabel = new JLabel(card.getName());
	        	ingredientNameLabel.setForeground(Color.WHITE);
	        	ingredientNameLabel.setFont(new Font("Arial", Font.BOLD, 12));
	        	ingredientNameLabel.setBounds(x, y+labelHeight+20, labelWidth, 14);
            	contentPane.add(ingredientNameLabel);
